...
export default function Page() {
  return (
    <div className='flex flex-col items-center justify-evenly' style={{minHeight:"calc(100vh - 4rem)"}}>
      ...
      <div className="py-4 rounded-2xl w-full xs:w-[95%] flex flex-col lg:flex-row gap-4 items-center justify-evenly">
        <div className="bg-slate-900 py-4 px-6 sm:px-12 sm:py-6 w-[95%] rounded-2xl max-w-[600px]">I am a passionate web developer. Pursuing a Bachelor&apos;s degree in Computer Science, adept at front-end
