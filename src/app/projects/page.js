...
export default function page() {
  return (
    <div className='flex flex-col pt-5'>
      ...
      <div className="bg-gradient-to-r from-slate-950/20 to-gray-50 dark:from-gray-950 dark:via-sky-950 dark:to-slate-900 shadow-[0_0_7px_black] dark:shadow-[0_0_7px_white] hover:shadow-[0_0_8px_red] text-white w-[95%] md:w-[80%] max-w-[900px] my-[20px] mx-auto p-[10px] sm:p-[20px] min-h-[180px] text-center rounded-lg ">
        <h2 className="w-fit mx-auto my-2 px-4 py-2 bg-slate-950/10 dark:bg-transparent rounded-lg font-extrabold text-2xl drop-shadow-[3px_3px_1px_green] text-gray-50 dark:text-white">Student&rsquo;Media</h2>
      ...
      <div className="bg-gradient-to-r from-gray-950/20 to-gray-50 dark:from-gray-950 dark:via-sky-950 dark:to-slate-900 shadow-[0_0_7px_black] dark:shadow-[0_0_7px_white] hover:shadow-[0_0_8px_red] text-white w-[95%] md:w-[80%] max-w-[900px] my-[20px] mx-auto p-[10px] sm:p-[20px] min-h-[180px] text-center rounded-lg ">
        <h2 className="w-fit mx-auto my-2 px-4 py-2 bg-slate-950/10 dark:bg-transparent rounded-lg font-extrabold text-2xl drop-shadow-[3px_3px_1px_green] text-gray-50 dark:text-white">E-commerce Web App</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          ...
          <div className="flex flex-col sm:w-[55%]">
            <div className="font-mono text-[14px] my-3 text-gray-800 dark:text-gray-400 max-w-[450px]">I&apos;m working on a Full Stack Web Application for an Ecommerse platform. It is going to be a MERN Stack Project with all the functionalities for a Ecommerse website. It is currently in building process.</div>
            <div className="flex fle-col xm:flex-row gap-2 items-center justify-around">
      ...
      <div className="bg-gradient-to-r from-gray-950/20 to-gray-50 dark:from-gray-950 dark:via-sky-950 dark:to-slate-900 shadow-[0_0_7px_black] dark:shadow-[0_0_7px_white] hover:shadow-[0_0_8px_red] text-white w-[95%] md:w-[80%] max-w-[900px] my-[20px] mx-auto p-[10px] sm:p-[20px] min-h-[180px] text-center rounded-lg ">
        <h2 className="w-fit mx-auto my-2 px-4 py-2 bg-slate-950/10 dark:bg-transparent rounded-lg font-extrabold text-2xl drop-shadow-[3px_3px_1px_green] text-gray-50 dark:text-white">Node.js Chat App</h2>
      ...
      <div className="bg-gradient-to-r from-gray-950/20 to-gray-50 dark:from-gray-950 dark:via-sky-950 dark:to-slate-900 shadow-[0_0_7px_black] dark:shadow-[0_0_7px_white] hover:shadow-[0_0_8px_red] text-white w-[95%] md:w-[80%] max-w-[900px] my-[20px] mx-auto p-[10px] sm:p-[20px] min-h-[180px] text-center rounded-lg ">
        <h2 className="w-fit mx-auto my-2 px-4 py-2 bg-slate-950/10 dark:bg-transparent rounded-lg font-extrabold text-2xl drop-shadow-[3px_3px_1px_green] text-gray-50 dark:text-white">Password Generator</h2>
      ...
      <div className="bg-gradient-to-r from-gray-950/20 to-gray-50 dark:from-gray-950 dark:via-sky-950 dark:to-slate-900 shadow-[0_0_7px_black] dark:shadow-[0_0_7px_white] hover:shadow-[0_0_8px_red] text-white w-[95%] md:w-[80%] max-w-[900px] my-[20px] mx-auto p-[10px] sm:p-[20px] min-h-[180px] text-center rounded-lg ">
        <h2 className="w-fit mx-auto my-2 px-4 py-2 bg-slate-950/10 dark:bg-transparent rounded-lg font-extrabold text-2xl drop-shadow-[3px_3px_1px_green] text-gray-50 dark:text-white">Simen Says</h2>
        <p className='text-[12px] italic text-yellow-600 dark:drop-shadow-[0_0_2px_black] font-bold' ><span className='font-semibold' >Tools & technologies used :</span> HTML , CSS , JavaScript</p>
      ...
      <div className="bg-gradient-to-r from-gray-950/20 to-gray-50 dark:from-gray-950 dark:via-sky-950 dark:to-slate-900 shadow-[0_0_7px_black] dark:shadow-[0_0_7px_white] hover:shadow-[0_0_8px_red] text-white w-[95%] md:w-[80%] max-w-[900px] my-[20px] mx-auto p-[10px] sm:p-[20px] min-h-[180px] text-center rounded-lg ">
        <h2 className="w-fit mx-auto my-2 px-4 py-2 bg-slate-950/10 dark:bg-transparent rounded-lg font-extrabold text-2xl drop-shadow-[3px_3px_1px_green] text-gray-50 dark:text-white">Temperature Convertor</h2>
        <p className='text-[12px] italic text-yellow-600 dark:drop-shadow-[0_0_2px_black] font-bold' ><span className='font-semibold' >Tools & technologies used :</span> HTML , CSS , JavaScript</p>
      ...
      <div className="bg-gradient-to-r from-gray-950/20 to-gray-50 dark:from-gray-950 dark:via-sky-950 dark:to-slate-900 shadow-[0_0_7px_black] dark:shadow-[0_0_7px_white] hover:shadow-[0_0_8px_red] text-white w-[95%] md:w-[80%] max-w-[900px] my-[20px] mx-auto p-[10px] sm:p-[20px] min-h-[180px] text-center rounded-lg ">
        <h2 className="w-fit mx-auto my-2 px-4 py-2 bg-slate-950/10 dark:bg-transparent rounded-lg font-extrabold text-2xl drop-shadow-[3px_3px_1px_green] text-gray-50 dark:text-white">Task Manager(ToDo List)</h2>
      ...
      <div className="bg-gradient-to-r from-gray-950/20 to-gray-50 dark:from-gray-950 dark:via-sky-950 dark:to-slate-900 shadow-[0_0_7px_black] dark:shadow-[0_0_7px_white] hover:shadow-[0_0_8px_red] text-white w-[95%] md:w-[80%] max-w-[900px] my-[20px] mx-auto p-[10px] sm:p-[20px] min-h-[180px] text-center rounded-lg ">
        <h2 className="w-fit mx-auto my-2 px-4 py-2 bg-slate-950/10 dark:bg-transparent rounded-lg font-extrabold text-2xl drop-shadow-[3px_3px_1px_green] text-gray-50 dark:text-white">Audio Player Web App</h2>
      ...
      <div className="bg-gradient-to-r from-gray-950/20 to-gray-50 dark:from-gray-950 dark:via-sky-950 dark:to-slate-900 shadow-[0_0_7px_black] dark:shadow-[0_0_7px_white] hover:shadow-[0_0_8px_red] text-white w-[95%] md:w-[80%] max-w-[900px] my-[20px] mx-auto p-[10px] sm:p-[20px] min-h-[180px] text-center rounded-lg ">
        <h2 className="w-fit mx-auto my-2 px-4 py-2 bg-slate-950/10 dark:bg-transparent rounded-lg font-extrabold text-2xl drop-shadow-[3px_3px_1px_green] text-gray-50 dark:text-white">Text-Utilities-App</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          ...
          <div className="flex flex-col sm:w-[55%]">
            <div className="font-mono text-[14px] my-3 text-gray-800 dark:text-gray-400 max-w-[450px]">It&apos;s also a basic frontend web application designed for some basic text utilities with the help of eventlisteners and JavaScript functionalities. zit comes with a good looking and Interactive UI.</div>
            <div className="flex fle-col xm:flex-row gap-2 items-center justify-around">
      ...
      <div className="bg-gradient-to-r from-gray-950/20 to-gray-50 dark:from-gray-950 dark:via-sky-950 dark:to-slate-900 shadow-[0_0_7px_black] dark:shadow-[0_0_7px_white] hover:shadow-[0_0_8px_red] text-white w-[95%] md:w-[80%] max-w-[900px] my-[20px] mx-auto p-[10px] sm:p-[20px] min-h-[180px] text-center rounded-lg ">
        <h2 className="w-fit mx-auto my-2 px-4 py-2 bg-slate-950/10 dark:bg-transparent rounded-lg font-extrabold text-2xl drop-shadow-[3px_3px_1px_green] text-gray-50 dark:text-white">Tic-Tac-Toe</h2>
        <p className='text-[12px] italic text-yellow-600 dark:drop-shadow-[0_0_2px_black] font-bold' ><span className='font-semibold' >Tools & technologies used :</span> ReactJs , CSS , Routes</p>
      ...
      <div className="bg-gradient-to-r from-gray-950/20 to-gray-50 dark:from-gray-950 dark:via-sky-950 dark:to-slate-900 shadow-[0_0_7px_black] dark:shadow-[0_0_7px_white] hover:shadow-[0_0_8px_red] text-white w-[95%] md:w-[80%] max-w-[900px] my-[20px] mx-auto p-[10px] sm:p-[20px] min-h-[180px] text-center rounded-lg ">
        <h2 className="w-fit mx-auto my-2 px-4 py-2 bg-slate-950/10 dark:bg-transparent rounded-lg font-extrabold text-2xl drop-shadow-[3px_3px_1px_green] text-gray-50 dark:text-white">Real-time LeaderBoard Management</h2>
      ...
      <div className="bg-gradient-to-r from-gray-950/20 to-gray-50 dark:from-gray-950 dark:via-sky-950 dark:to-slate-900 shadow-[0_0_7px_black] dark:shadow-[0_0_7px_white] hover:shadow-[0_0_8px_red] text-white w-[95%] md:w-[80%] max-w-[900px] my-[20px] mx-auto p-[10px] sm:p-[20px] min-h-[180px] text-center rounded-lg ">
        <h2 className="w-fit mx-auto my-2 px-4 py-2 bg-slate-950/10 dark:bg-transparent rounded-lg font-extrabold text-2xl drop-shadow-[3px_3px_1px_green] text-gray-50 dark:text-white">News-Hunt</h2>
        <p className='text-[12px] italic text-yellow-600 dark:drop-shadow-[0_0_2px_black] font-bold' ><span className='font-semibold' >Tools & technologies used :</span> ReactJs , CSS , Routes</p>

        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <Link href={'/projects'} target='blank' className='mx-auto rounded shadow-[0_0_3px_black] dark:shadow-[0_0_5px_white] my-4 max-h-[250px] sm:w-[40%] overflow-hidden'><Image src={'/img/projects/pending.png'} alt='demo-image' width={400} height={250} className='' /> </Link>
          <div className="flex flex-col sm:w-[55%]">
            <div className="font-mono text-[14px] my-3 text-gray-800 dark:text-gray-400 max-w-[450px]">A React based News Application for current/Daily news (data from news api)I created a news website for current(daily) news using the data of a NEWS API and I created some sections of interests</div>
            <div className="flex fle-col xm:flex-row gap-2 items-center justify-around">
      ...
      <div className="bg-gradient-to-r from-gray-950/20 to-gray-50 dark:from-gray-950 dark:via-sky-950 dark:to-slate-900 shadow-[0_0_7px_black] dark:shadow-[0_0_7px_white] hover:shadow-[0_0_8px_red] text-white w-[95%] md:w-[80%] max-w-[900px] my-[20px] mx-auto p-[10px] sm:p-[20px] min-h-[180px] text-center rounded-lg ">
        <h2 className="w-fit mx-auto my-2 px-4 py-2 bg-slate-950/10 dark:bg-transparent rounded-lg font-extrabold text-2xl drop-shadow-[3px_3px_1px_green] text-gray-50 dark:text-white">Weather-App</h2>
        <p className='text-[12px] italic text-yellow-600 dark:drop-shadow-[0_0_2px_black] font-bold' ><span className='font-semibold' >Tools & technologies used :</span> HTML , CSS , JavaScript</p>
