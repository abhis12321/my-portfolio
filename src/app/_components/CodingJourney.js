    ...
    <section className="gap-6 bg-slate-950/5 dark:bg-gray-950 text-white py-5 flex items-center justify-center flex-col" id="learnings">
      ...
      <div className="min-h-[40vh] flex gap-3 w-[98%] max-w-[850px] rounded-lg shadow-[0_0_5px_black] dark:shadow-[0_0_10px_white] hover:shadow-[0_0_10px_red] bg-slate-200 dark:bg-gray-900 p-1 px-4 ">
        ...
        <div className="flex flex-col justify-center items-center py-4 xs:w-[70%]">
          ...
          <p className="font-mono text-[14px] text-gray-600 dark:text-gray-400 py-3">
      ...
      <div className="min-h-[40vh] flex gap-3 w-[98%] max-w-[850px] rounded-lg shadow-[0_0_5px_black] dark:shadow-[0_0_10px_white] hover:shadow-[0_0_10px_red] bg-slate-200 dark:bg-gray-900 p-1 px-4 ">
        <div className="flex flex-col justify-center items-center py-4 xs:w-[30%] ">
          ...
          />
          <h3 className="font-bold drop-shadow-[3px_3px_1px_red] bg-slate-950/5 px-4 py-[6px] rounded-lg">Java</h3>
        </div>
        <div className="flex flex-col justify-center items-center py-4 xs:w-[70%]">
          <h2 className="bg-gray-950/50 dark:bg-gray-950 font-bold px-4 py-2 rounded">
            August 2022
      ...
      <div className="min-h-[40vh] flex gap-3 w-[98%] max-w-[850px] rounded-lg shadow-[0_0_5px_black] dark:shadow-[0_0_10px_white] hover:shadow-[0_0_10px_red] bg-slate-200 dark:bg-gray-900 p-1 px-4 ">
        <div className="flex flex-col justify-center items-center xs:w-[30%] ">
          ...
          />
          <h3 className="font-bold drop-shadow-[3px_3px_1px_red] bg-slate-950/5 px-4 py-[6px] rounded-lg">HTML</h3>
        </div>
        <div className="flex flex-col justify-center items-center py-4 xs:w-[70%]">
          <h2 className="bg-gray-950/50 dark:bg-gray-950 font-bold px-4 py-2 rounded">
            December 2022
      ...
      <div className="min-h-[40vh] flex gap-3 w-[98%] max-w-[850px] rounded-lg shadow-[0_0_5px_black] dark:shadow-[0_0_10px_white] hover:shadow-[0_0_10px_red] bg-slate-200 dark:bg-gray-900 p-1 px-4 ">
        <div className="flex flex-col justify-center items-center xs:w-[30%] ">
          ...
          />
          <h3 className="font-bold drop-shadow-[3px_3px_1px_red] bg-slate-950/5 px-4 py-[6px] rounded-lg">CSS</h3>
        </div>
        <div className="flex flex-col justify-center items-center py-4 xs:w-[70%]">
          <h2 className="bg-gray-950/50 dark:bg-gray-950 font-bold px-4 py-2 rounded">
            December 2022
      ...
      <div className="min-h-[40vh] flex gap-3 w-[98%] max-w-[850px] rounded-lg shadow-[0_0_5px_black] dark:shadow-[0_0_10px_white] hover:shadow-[0_0_10px_red] bg-slate-200 dark:bg-gray-900 p-1 px-4 ">
        <div className="flex flex-col justify-center items-center xs:w-[30%] ">
          ...
          />
          <h3 className="font-bold drop-shadow-[3px_3px_1px_red] bg-slate-950/5 px-4 py-[6px] rounded-lg">JavaScript</h3>
        </div>
        <div className="flex flex-col justify-center items-center py-4 xs:w-[70%]">
          <h2 className="bg-gray-950/50 dark:bg-gray-950 font-bold px-4 py-2 rounded">
            February 2023
      ...
      <div className="min-h-[40vh] flex gap-3 w-[98%] max-w-[850px] rounded-lg shadow-[0_0_5px_black] dark:shadow-[0_0_10px_white] hover:shadow-[0_0_10px_red] bg-slate-200 dark:bg-gray-900 p-1 px-4 ">
        <div className="flex flex-col justify-center items-center xs:w-[30%] ">
          ...
          />
          <h3 className="font-bold drop-shadow-[3px_3px_1px_red] bg-slate-950/5 px-4 py-[6px] rounded-lg">Bootstrap</h3>
        </div>
        <div className="flex flex-col justify-center items-center py-4 xs:w-[70%]">
          <h2 className="bg-gray-950/50 dark:bg-gray-950 font-bold px-4 py-2 rounded">
            April 2023
      ...
      <div className="min-h-[40vh] flex gap-3 w-[98%] max-w-[850px] rounded-lg shadow-[0_0_5px_black] dark:shadow-[0_0_10px_white] hover:shadow-[0_0_10px_red] bg-slate-200 dark:bg-gray-900 p-1 px-4 ">
        <div className="flex flex-col justify-center items-center xs:w-[30%] ">
          ...
          />
          <h3 className="font-bold drop-shadow-[3px_3px_1px_red] bg-slate-950/5 px-4 py-[6px] rounded-lg">Git & Github</h3>
        </div>
        <div className="flex flex-col justify-center items-center py-4 xs:w-[70%]">
          <h2 className="bg-gray-950/50 dark:bg-gray-950 font-bold px-4 py-2 rounded">
            May 2023
      ...
      <div className="min-h-[40vh] flex gap-3 w-[98%] max-w-[850px] rounded-lg shadow-[0_0_10px_white] hover:shadow-[0_0_15px_red] bg-slate-700 dark:bg-gray-900 p-1 px-2 xs:px-4 ">
        <div className="flex flex-col justify-center items-center xs:w-[30%] ">
          ...
          />
          <h3 className="font-bold drop-shadow-[3px_3px_1px_red] bg-slate-950/5 px-4 py-[6px] rounded-lg">ReactJS</h3>
        </div>
        <div className="flex flex-col justify-center items-center py-4 xs:w-[70%]">
          <h2 className="bg-gray-950/50 dark:bg-gray-950 font-bold px-4 py-2 rounded">
            June 2023
      ...
      <div className="min-h-[40vh] flex gap-3 w-[98%] max-w-[850px] rounded-lg shadow-[0_0_10px_white] hover:shadow-[0_0_15px_red] bg-slate-700 dark:bg-gray-900 px-3 xs:px-4">
        <div className="flex flex-col justify-center items-center py-4 xs:w-[30%]">
          ...
          />
          <h3 className="font-bold drop-shadow-[3px_3px_1px_red] bg-slate-950/5 px-4 py-[6px] rounded-lg">NextJS</h3>
        </div>
        <div className="flex flex-col justify-center items-center py-4 xs:w-[70%]">
          <h2 className="bg-gray-950/50 dark:bg-gray-950 font-bold px-4 py-2 rounded">
            September 2023
