...
export default function About() {
  return (
    <div className="flex flex-col items-center justify-evenly pt-10 pb-6 bg-blue-950/5" id="about">
      <div className="rounded-2xl w-[98%] max-w-[650px] flex flex-col items-center justify-evenly bg-gradient-to-b from-slate-200 to-slate-200 dark:from-slate-900/90 dark:via-cyan-950 dark:to-slate-900 shadow-[0_0_5px_black] dark:shadow-[0_0_5px_white] py-6 px-3 xs:px-6 sm:px-12">
