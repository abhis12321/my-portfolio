...
export default function CodingProfile() {
  return (
    <div className='bg-blue-950/5 py-6'>
      <h1 className='mx-auto text-center text-4xl rounded-md drop-shadow-[3px_3px_1px_black] dark:drop-shadow-[3px_3px_1px_white] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-violet-700 w-[98%] xs:w-fit pt-1 pb-8'>Coding Profile</h1>
