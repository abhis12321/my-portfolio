  ...
  return (
    <div className='bg-transparent py-7'>
      <div className="w-full">
        <div className="flex flex-wrap gap-[6px] xs:gap-4 items-center justify-center  bg-gradient-to-r md:bg-gradient-to-b from-white to-gray-50 dark:from-cyan-950 dark:to-blue-950 p-[6px] xs:p-4 rounded-lg max-w-[1150px] w-[98%] mx-auto shadow-[0_0_5px_gray] dark:shadow-[0_0_5px_white]">
          ...
          <div className="flex flex-col justify-evenly bg-blue-50 dark:bg-blue-600/10 rounded-lg px-6 py-4 w-full max-w-[440px] sm:w-[48%] lg:w-[32%] xs:min-w-[360px] sm:min-w-[289px] lg:min-w-[220px] h-[164px] shadow-[1px_1px_1px_black]">
