...
export default function ProjectCard({ project }) {
  ...
  return (
    <div className="bg-white hover:bg-blue-50 dark:bg-white/10 dark:hover:bg-cyan-950/40 shadow-[0_0_2px_black_inset] dark:shadow-[0_0_2px_gray_inset] hover:shadow-[0_0_3px_black] dark:hover:shadow-[0_0_3px_white] text-white w-[97%] max-w-[900px] mx-auto p-[10px] sm:px-[20px] min-h-[180px] text-center rounded-lg">
      ...
      <div className="flex flex-col sm:flex-row sm:gap-4 items-center">
        <Link href={deployement} target='blank' className='mx-auto rounded shadow-[0_0_2px_black] dark:shadow-[0_0_2px_white] my-4 max-h-[250px] sm:w-[40%] overflow-hidden hover:scale-105' ><Image src={image} alt='demo-image' width={400} height={250} className='' /></Link>
        <div className="flex flex-col sm:w-[55%]">
          ...
          <div className="flex fle-col xm:flex-row gap-2 items-center justify-around">
            ...
            <Link className='px-3 text-[14px] sm:text-[.9rem] sm:px-4 py-[7px] rounded bg-slate-950/70 dark:bg-slate-950 hover:shadow-[0_0_3px_white] hover:bg-black duration-1000 font-semibold' target='_blank' href={deployement}>Take a Look...</Link>
          </div>
        </div>
      </div>
    </div>
