...
export default function PWC_Badges() {
  return (
    <div className='flex flex-wrap items-center justify-between gap-4 max-w-[1150px] w-[98%] mx-auto bg-white dark:bg-transparent shadow-[0_0_5px_gray] dark:shadow-none mt-3 md:mt-4 rounded-xl text-gray-400 text-7xl xs:text-8xl sm:text-[9rem] relative pt-4 lg:pb-7 sm:p-5 pb-4 px-1'>
