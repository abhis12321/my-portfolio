...
export default function NavBar() {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-gray-400 to-slate-600 dark:from-blue-950 dark:via-violet-950 dark:to-red-950 text-gray-100 font-semibold flex items-center justify-between h-16 px-4 xm:px-8 overflow-hidden border-b2 border-cyan-950">
      <div className="">
        <h2 className="font-bold text-3xl text-center rounded-md text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-orange-600 w-fit leading-[4rem] overflow-hidden drop-shadow-[0_0_1px_black] font-serif"><span className="font-extrabold font-sans">@</span>bhishek singh</h2>
      </div>
