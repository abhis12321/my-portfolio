...
export default function NavBar() {
  ...
  return (
    <div className="sticky top-0 left-0 z-50 w-full mx-auto bg-white dark:bg-gradient-to-r dark:from-indigo-950 dark:to-blue-950 font-bold flex items-center justify-between h-[4rem] px-4 xs:px-5 md:pl-7 md:pr-6 overflow-hidden italic shadow-[1px_1px_2px_gray] dark:shadow-[1px_1px_2px_black]">
      <div className="">
