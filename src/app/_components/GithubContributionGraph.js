...
export default function GithubCintributionGraph() {
  return (
    <div className='flex flex-col items-center justify-center scale-y-150 sm:scale-y-125 md:scale-100 py-16 md:py-6 bg-transparent'>
      ...
      <img
              ...
              className='rounded w-[98%] max-w-[1150px] ring-1 ring-sky-500'
            />
    </div>
  )
}
