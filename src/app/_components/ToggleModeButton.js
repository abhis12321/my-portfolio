...
export default function ToggleModeButton() {
  ...
  return (
    <div className='cursor-pointer *:bg-gray-500 *:rounded-full flex items-center *:hover:scale-110 justify-center h-8 w-8 mx-auto py-8 lg:py-0 lg:ml-4' onClick={toggleMode}>
