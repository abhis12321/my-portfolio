...
export default function Contact() {
  ...
  return (
    <div className='flex justify-center items-center py-6 bg-blue-950/5' id='contact'>
      <form className="flex flex-wrap items-center justify-center gap-[3px] text-white bg-gradient-to-b from-white to-gray-50 dark:bg-gradient-to-b dark:from-slate-800 dark:via-cyan-950 dark:to-slate-900 w-[98%] max-w-[900px] px-[2px] xs:px-2 py-1 xs:py-4 sm:py-2 rounded-lg shadow-[0px_0px_4px_indigo] dark:shadow-[0_0_5px_white]" onSubmit={handleSubmit} data-aos="fade-up">
        ...
        <div className="flex-1 hidden sm:block w-fit">
          <Image src={'/img/others/contact.png'} alt='contact' height={350} width={330} className='opacity-90 dark:opacity-80'/>
        </div>

        <div className="flex flex-col gap-[2px] xs:gap-1 w-[98%] sm:w-[60%] sm:max-w-[430px]">
          ...
          <div className="group w-full flex relative">
            ...
            <textarea value={message} onChange={e => setMessage(e.target.value)} placeholder='Enter your message' cols="25" rows="10" className='w-full bg-blue-950/15 dark:bg-slate-950/45 text-cyan-950 dark:text-gray-400 placeholder:text-gray-500 dark:placeholder:text-gray-600 font-medium focus:text-sky-700 focus:bg-blue-950/40 dark:focus:bg-slate-950/60 focus:border-violet-700 dark:focus:border-violet-900 border-2 border-gray-700 p-3 px-14 outline-none rounded-md' required></textarea></div>
          <input type="submit" value={'Send'} className='bg-red-900 hover:bg-red-700 active:bg-violet-900 border-2 border-gray-700 p-2 text-center outline-none rounded-md font-bold cursor-pointer' required />
