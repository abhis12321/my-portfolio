...
export default function Contact() {
  ...
  return (
    <div className='flex justify-center items-center py-4 bg-blue-950/5' id='contact'>
      <form className="flex flex-col gap-[3px] sm:gap-1 text-white bg-gradient-to-b from-gray-50 to-blue-50 dark:bg-gradient-to-b dark:from-slate-900 dark:via-cyan-950 dark:to-slate-900 w-[98%] max-w-[700px] px-2 xs:px-3 md:px-6 py-4 sm:py-6 rounded-lg shadow-[0px_0px_4px_indigo] dark:shadow-[0_0_5px_white] dark:hover:shadow-[0_0_8px_white]" onSubmit={handleSubmit} data-aos="fade-up">
        <div className="drop-shadow-[3px_3px_1px_black] dark:drop-shadow-[1px_1px_1px_white] py-3">
          <h1 className='mx-auto text-center text-4xl rounded-md drop-shadow-[1px_1px_1px_white] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-violet-700 w-[95%] xs:w-fit pb-4'>Contact me</h1>
        </div>
