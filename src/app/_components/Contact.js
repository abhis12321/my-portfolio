...
export default function Contact() {
  ...
  return (
    <div className='flex justify-center items-center py-6 bg-blue-950/5' id='contact'>
      <form className="flex flex-wrap items-center justify-between gap-[3px] text-white bg-gradient-to-bl from-white to-gray-50 dark:from-blue-950 dark:via-cyan-950 dark:to-slate-900 w-[98%] max-w-[950px] px-[2px] xs:px-4 py-1 xs:py-4 sm:py-2 rounded-lg shadow-[0px_0px_4px_indigo] dark:shadow-[0_0_5px_white]" onSubmit={handleSubmit} data-aos="fade-up">
