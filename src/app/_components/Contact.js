...
export default function Contact() {
  ...
  return (
    <div className='flex justify-center items-center py-6 bg-blue-950/5' id='contact'>
      <form className="flex flex-wrap items-center justify-around gap-[3px] text-white bg-gradient-to-b from-white to-gray-50 dark:from-cyan-950 dark:to-blue-950/90 w-[98%] max-w-[1150px] p-1 xs:p-3 sm:p-2 rounded-lg shadow-[0px_0px_4px_indigo] dark:shadow-[0_0_5px_white]" onSubmit={handleSubmit} data-aos="fade-up">
        ...
        <div className="flex flex-col gap-[2px] xs:gap-1 w-[100%] sm:w-[60%] sm:max-w-[500px]">
          <div className="group w-full flex relative">
            ...
            <input type="text" value={name} onChange={e => setName(e.target.value)} placeholder='Enter your name' className='w-full bg-blue-950/15 dark:bg-slate-950/45 text-cyan-950 dark:text-gray-400 placeholder:text-gray-500 dark:placeholder:text-gray-600 font-medium focus:text-sky-700 focus:bg-blue-950/40 dark:focus:bg-slate-950/60 focus:border-violet-700 dark:focus:border-violet-900 border-2 border-gray-500 p-3 px-14 outline-none rounded-md' required />
          </div>
          <div className="group w-full flex relative">
          ...
          <div className="group w-full flex relative">
            ...
            <textarea value={message} onChange={e => setMessage(e.target.value)} placeholder='Enter your message' cols="25" rows="9" className='w-full bg-blue-950/15 dark:bg-slate-950/45 text-cyan-950 dark:text-gray-400 placeholder:text-gray-500 dark:placeholder:text-gray-600 font-medium focus:text-sky-700 focus:bg-blue-950/40 dark:focus:bg-slate-950/60 focus:border-violet-700 dark:focus:border-violet-900 border-2 border-gray-500 p-3 px-14 outline-none rounded-md' required></textarea></div>
