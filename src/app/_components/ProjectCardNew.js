...
export default function ProjectCardNew({ project }) {
    return (
        <div className='w-[500px] h-[530px] rounded-sm overflow-hidden shadow-[0_0_2px_gray] hover:shadow-[2px_2px_4px_green] bg-white dark:bg-white/10 ring-1 ring-gray-600 hover:ring-blue-600 hover:scale-[1.008] group relative flex flex-col items-center pb-2'>
            <Link href={project.deployement} className="h-[280px] w-full flex items-center justify-center">
            ...
            <div className="w-full px-4 sm:px-6 py-2 flex flex-col items-center justify-center gap-[6px]">
                ...
                <div className="text-xs text-yellow-500/90">{project.technology}</div>
