...
export default function Skills() {
  return (
    <div className="flex flex-col flex-wrap items-center justify-center bg-blue-950/5 py-6">
      <div className="max-w-[1150px] w-[98%] mx-auto bg-gradient-to-b from-blue-50/50 to-blue-100/20 dark:from-cyan-950 dark:to-blue-950 shadow-[0_0_5px_black] dark:shadow-[0_0_5px_white] py-5 my-3 md:my-4 rounded-xl text-gray-400 text-7xl xs:text-8xl sm:text-[9rem] relative">
        <div className="w-fulldropshadow-[3px_3px_1px_red] flex gap-3 items-center justify-center text-[2.8rem] font-extrabold font-serif text-slate-600 dark:text-blue-50 pt-5 pb-7  max-h-16 overflow-hidden">
          <FontAwesomeIcon size='xs' icon={faLaptopCode} className='text-[2.8rem]' /> Skills
        </div>

        <div className="flex flex-wrap justify-center gap-3 md:gap-5 rounded-xl">
          <div className="flex flex-wrap items-center justify-center gap-3 xs:gap-5 sm:gap-8 px-4 py-5 rounded-lg bg-blue-600/10 dark:bg-blue-600/10 w-[98%] md:w-[47%] max-w-[600px]">
