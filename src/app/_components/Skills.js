  ...
  return (
    <div className="flex flex-col flex-wrap items-center justify-center bg-transparent py-6">
      ...
      <div className="max-w-[1150px] w-[98%] mx-auto bg-gradient-to-r md:bg-gradient-to-b from-white to-gray-50 dark:from-cyan-950 dark:to-blue-950 shadow-[0_0_5px_gray] dark:shadow-[0_0_5px_white] mt-3 md:mt-4 rounded-xl text-gray-400 text-7xl xs:text-8xl sm:text-[9rem] relative">
        <div className="flex flex-wrap justify-evenly gap-2 md:gap-3 rounded-xl py-2 px-1 xs:px-2 xs:py-3 sm:px-3 md:p-4">
          ...
          <div className="flex flex-col items-center justify-center w-[98%] md:w-[49%] max-w-[500px] py-2">
            <div className="drop-shadow-[3px_3px_1px_black] dark:drop-shadow-[2px_2px_1px_white] pb-5 w-full font-extrabold">
              <div className="py-1 mx-auto text-center drop-shadow-[1px_1px_1px_white] flex gap-3 items-center justify-center text-[2rem] max-h-16 overflow-hidden font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-violet-600 w-fit">
                Development Skills
              </div>
            </div>
