...
export default function Skills() {
  return (
    <div className="flex flex-col flex-wrap items-center justify-center bg-transparent py-6">
      <div className="max-w-[1150px] w-[98%] mx-auto bg-white dark:bg-white/10 shadow-[0_0_5px_gray] mt-3 md:mt-4 rounded-xl text-gray-400 text-7xl xs:text-8xl sm:text-[9rem] relative lg:pb-4 sm:pt-1">
        ...
        <div className="flex flex-wrap items-center justify-evenly gap-2 md:gap-3 rounded-xl py-2 px-1 xs:px-2 xs:py-3 sm:px-3 md:px-4">
          ...
          <div className="flex flex-col items-center justify-center w-[98%] md:w-[49%] max-w-[500px] py-2">
            <div className="drop-shadow-[3px_3px_1px_black] dark:drop-shadow-[1px_1px_1px_gray] pb-5 w-full font-extrabold">
              <div className="py-1 mx-auto text-center drop-shadow-[0px_0px_1px_black] flex gap-3 items-center justify-center text-[1.8rem] max-h-16 overflow-hidden font-extrabold text-gray-300 dark:text-white w-fit">
                Development Skills
              </div>
            </div>

            <div className="flex flex-wrap items-center justify-center gap-3 px-2 sm:px-3 py-5 rounded-lg bg-blue-600/10 dark:bg-white/5 shadow-[0_0_1px_white] outline-none">
